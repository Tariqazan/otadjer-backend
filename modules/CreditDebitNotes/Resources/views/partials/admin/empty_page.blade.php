<div class="card">
    <div class="row align-items-center">
        ...
        <div class="col-xs-12 col-sm-6 text-center p-5">
            <p class="text-justify description">{!! trans('credit-debit-notes::general.empty.' . $page) !!} {!! trans('general.empty.documentation', ['url' => 'https://otadjer.com/docs/app-manual/accounting/' . $docs_path]) !!}</p>
