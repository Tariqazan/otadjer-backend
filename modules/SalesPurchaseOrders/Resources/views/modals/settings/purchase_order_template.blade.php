<div class="modal-body pb-0">
    {!! Form::open([
            'route' => 'sales-purchase-orders.modals.purchase-order-template.update',
            'method' => 'PATCH',
            'id' => 'template',
            ...
            @stack('color_input_start')
                <div class="form-group col-md-12 {{ $errors->has('color') ? 'has-error' : ''}}">
                    ...
                    <div class="input-group input-group-merge" id="invoice-color-picker">
                        ...
                        {!! Form::text('color', setting('sales-purchase-orders.purchase_order.color'), ['v-model' => 'invoice_form.color', '@input' => 'onChangeColorInput', 'id' => 'color', 'class' => 'form-control color-hex', 'required' => 'required']) !!}
                    </div>
        ...
        {!! Form::hidden('_template', setting('sales-purchase-orders.purchase_order.template')) !!}
