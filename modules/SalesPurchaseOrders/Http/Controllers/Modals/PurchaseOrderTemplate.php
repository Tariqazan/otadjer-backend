...
class PurchaseOrderTemplate extends Controller
{
    ...
    {
        $fields = $request->all();
        $prefix = $request->get('_prefix', 'sales-purchase-orders.purchase_order');
        ...
        $response = [
            ...
            'message'  => $message,
            'data'     => null,
            'redirect' => route('sales-purchase-orders.settings.purchase-order.edit'),
        ];
