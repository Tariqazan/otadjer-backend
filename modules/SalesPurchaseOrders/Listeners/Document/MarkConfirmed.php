...
use Modules\SalesPurchaseOrders\Events\Confirmed as Event;
...
class MarkConfirmed
{
    ...
    {
        $event->document->status = 'confirmed';
        $event->document->save();
            ...
            new CreateDocumentHistory(
                ...
                trans(
                    ...
                    [
                        ...
                        'status' => Str::lower(trans("sales-purchase-orders::{$type}.statuses.confirmed"))
                    ]
                )
            )
        );
