         ...
         <div class="card-header border-bottom-0" v-bind:class="[bulk_action.show ? 'bg-gradient-primary' : '']">
            {!! Form::open([
                ...
                <div class="align-items-center" v-if="!bulk_action.show">
                    <x-search-string model="Modules\CustomFields\Models\Field" />
                </div>

                {{ Form::bulkActionRowGroup('custom-fields::general.name', $bulk_actions, ['group' => 'custom-fields', 'type' => 'fields']) }}
            {!! Form::close() !!}
        </div>
        <!-- /.box-header -->
            ...
            <table class="table table-flush table-hover" id="tbl-custom-fields">
                <thead class="thead-light">
                    <tr class="row table-head-line">
                        ...
                        <th class="col-md-3">@sortablelink('location.name', trans_choice('custom-fields::general.locations', 1))</th>
                        <th class="col-md-2">@sortablelink('type.name', trans_choice('general.types', 1))</th>
                        ...
                        <td class="col-xs-4 col-sm-3 col-md-2 col-lg-1 col-xl-1 text-center border-0">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    {!! Form::deleteLink($item, 'custom-fields.fields.destroy', 'custom-fields::general.name') !!}
                                    @endpermission
                                </div>
                            </div>
                        </td>
