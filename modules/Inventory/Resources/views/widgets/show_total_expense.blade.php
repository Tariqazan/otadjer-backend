		...
		<div class="card-body">
			<div class="row">
				<div class="col-xl-8 col-lg-8 col-md-6 col-sm-10 col-xs-10">
					<h5 class="card-title text-uppercase text-muted mb-1 text-white long-texts">{{ trans('inventory::widgets.total_expense') }}</h5>
                    <span class="font-weight-bold mb-0 text-white">@money($total_expense,
