    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                {{ Form::textGroup('transfer_order_number', trans_choice('inventory::transferorders.transfer_order_number', 1), 'id-card-o', ['required' => 'required'], old('transfer_order_number', $transfer_order->transfer_order_number)) }}

                {{ Form::dateGroup('date', trans('general.date'), 'calendar', ['id' => 'closed_at', 'required' => 'required', 'class' => 'form-control datepicker', 'show-date-format' => company_date_format(), 'date-format' => 'Y-m-d', 'autocomplete' => 'off'], Date::parse($transfer_order->date)->toDateString()) }}

                {{ Form::textGroup('reason', trans('inventory::transferorders.reason'), 'fas fa-question-circle', [], $transfer_order->reason) }}
