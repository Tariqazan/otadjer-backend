...
return [
    ...
    'deal_status_change'    => 'Статус угоди змінено!',
    'pipeline_stage_change' => 'Стадія конвеєра змінено!',
    'activity_type_change'  => 'Тип діяльності змінено!',
    'invoice_created'       => 'Рахунок-фактуру створено',
    'deal_is_broken'        => 'Угода розірвана',
    'deal_is_reopen'        => 'Угода знову відкрита',
    'send_mail'             => 'Електронного листа успішно надіслано',
