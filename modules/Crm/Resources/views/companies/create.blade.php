    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                {{ Form::selectAddNewGroup('contact_type', trans_choice('crm::general.contacts', 1), 'font', $crm_contact, '', ['path' => route('crm.modals.company.contact.create'), 'field' => ['key' => 'id', 'value' => 'name']]) }}
