{!! Form::model($schedule, [
    ...
    <div class="row">
        ...
        {{ Form::selectGroup('schedule_type', trans_choice('crm::general.logs', 1), 'terminal', $types, $schedule->schedule_type) }}
        ...
        {{ Form::selectGroup('user_id', trans_choice('general.users',1),'user-circle', $users, $schedule->user->id, ['required' => 'required', 'class' => 'form-control users']) }}
