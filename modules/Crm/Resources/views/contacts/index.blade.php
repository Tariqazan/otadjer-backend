        ...
        <div class="card">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center p-5">
                        <p class="text-justify description">{!! trans('general.empty.customers') !!} {!! trans('general.empty.documentation', ['url' => 'https://otadjer.com/docs/user-manual/crm/contacts']) !!}</p>
