    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                {{ Form::selectAddNewGroup('contact_type', trans_choice('crm::general.companies', 1), 'font', $crm_company, $contact->company, ['path' => route('crm.modals.contact.company.create'), 'field' => ['key' => 'id', 'value' => 'name']]) }}
