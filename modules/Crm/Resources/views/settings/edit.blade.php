                ...
                <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <button @click="onPipeline('{{trans('crm::general.add_pipeline')}}')"
                                        ...
                                        {{ trans('crm::general.add_pipeline') }}
                                    </button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach($pipeline as $line)
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                                                ...
                                                @permission('delete-crm-deals')
                                                    <div class="dropdown-divider"></div>
                                                    {!! Form::deleteLink($line, 'crm.setting.deal.pipeline.delete', 'crm::setting.pipeline') !!}
                                                @endpermission
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-header with-border">
                                            <div class="pipeline-stage-sortable" id="pipeline-sortable-{{ $line->id }}" style="display: inline-flex; margin-bottom: 10px;">
                                                ...
                                                <crm-stages
                                                    :delete-text = "'{{ trans('general.title.delete', ['type' => trans('crm::general.stage.title')]) }}'" 
                                                    :data = "{{ json_encode($line->stages()->orderBy('rank', 'asc')->get()) }}"
                                                ></crm-stages>
                                            </div>
                                        </div>
                                    @endforeach
                    ...
                    <div class="tab-pane" id="activity_type">
                        <crm-activity-types
                            ...
                            :delete-text = "'{{ trans('general.title.delete', ['type' => trans_choice('crm::setting.activity_type', 1)]) }}'" 
...
@push('scripts_start')
<script src="{{ asset('modules/Crm/Resources/assets/js/crm-settings.min.js?v=' .module_version('crm')) }}"></script>
@endpush
