...
use Modules\Crm\Http\Requests\ModalDealOwner as OwnerRequest;
use Modules\Crm\Http\Requests\ModalDealContact as ContactRequest;
use Modules\Crm\Http\Requests\ModalDealCompany as CompanyRequest;
...
class Deals extends Controller
{
    ...
    public function create()
    {
        ...
        $html = view('crm::modals.deals.create', compact('contacts', 'companies', 'owners', 'pipelines', 'currencies'))->render();
    ...
    public function edit(Deal $deal)
    {
        ...
        $html = view('crm::modals.deals.edit', compact('deal', 'contacts', 'companies', 'owners', 'pipelines', 'currencies'))->render();
    ...
    public function ownerEdit(Deal $deal)
    {
        $owners = \App\Models\Common\Company::find(company_id())->users()->pluck('name', 'id');
    ...
    public function ownerUpdate(Deal $deal, OwnerRequest $request)
    {
    ...
    public function companyEdit(Deal $deal)
    {
        $companies = Company::with('contact')->where('company_id', company_id())->get()->pluck('contact.name', 'id');
    ...
    public function companyUpdate(Deal $deal, CompanyRequest $request)
    {
    ...
    public function contactEdit(Deal $deal)
    {
        $contacts = Contact::with('contact')->where('company_id', company_id())->get()->pluck('contact.name', 'id');
    ...
    public function contactUpdate(Deal $deal, ContactRequest $request)
    {
