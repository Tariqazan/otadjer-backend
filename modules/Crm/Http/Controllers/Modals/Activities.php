...
class Activities extends Controller
{
    ...
    public function show($type, $type_id, $id)
    {
        ...
        $activity_types = DealActivityType::find($deal_activity->activity_type)->name;

        $html = view('crm::modals.activities.show', compact('deal_activity', 'activity_types'))->render();
     ...
     * @return Response
     */
    public function edit($type, $type_id, $id)
    {
     ...
     * @return Response
     */
    public function update($type, DealActivity $deal_activity, Request $request)
    {
     ...
     * @return Response
     */
    public function destroy($type, DealActivity $deal_activity)
    {
