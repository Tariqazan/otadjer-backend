...
use Modules\Crm\Database\Factories\Company as CompanyFactory;
use Illuminate\Database\Eloquent\Factories\HasFactory;

class Company extends Model
{
    use Cloneable, Media, Notifiable, DateTime, HasFactory;
    ...
    public function getCrmContactAttribute()
    {
        $company_contact = CompanyContact::where('crm_company_id', $this->id)->first();

        if (!empty($company_contact)) {
            $contact = Contact::where('id', $company_contact->crm_contact_id)->first();
