...
use Modules\Crm\Database\Factories\Contact as ContactFactory;
...
class Contact extends Model
{
    ...
    {
        $contact_company = CompanyContact::where('crm_contact_id', $this->id)->first();

        if (!empty($contact_company)) {
            $company = Company::where('id', $contact_company->crm_company_id)->first();
