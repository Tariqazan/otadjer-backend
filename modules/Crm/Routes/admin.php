...
/**
 * 'admin' middleware and 'crm' prefix applied to all routes (including names)
 *
...
Route::admin('crm', function () {
    ...
    // Deals
    Route::get('deals/activities/done/{activity}', 'Deals@done')->name('deal.activities.done');
    ...
    Route::get('deals/getContactCompany', 'Deals@getContactCompany')->name('deals.contactcompany');
    Route::get('deals/getCompanyContact', 'Deals@getCompanyContact')->name('deals.companycontact');
    ...
    Route::patch('modals/deals/{deal}/owners/{owner}/change', 'Modals\Deals@ownerUpdate')->name('modals.deals.owner.change.update');
    ...
    //send mail
    Route::get('modals/activities/{type}/{type_id}/emails/{id}/send', 'Modals\Emails@send')->name('modals.emails.send');
    ...
    Route::resource('modals/contact', 'Modals\Contacts', ['names' => 'modals.company.contact']);
    Route::resource('modals/contact/{contact}/company', 'Modals\ContactCompany', ['names' => 'modals.contacts']);
    Route::resource('modals/company', 'Modals\Companies', ['names' => 'modals.contact.company']);
    ...
    Route::resource('modals/activities/{type}/{deal_activity}/deals', 'Modals\Activities', ['names' => 'modals.deal-activities']);
    ...
    Route::group(['prefix' => 'settings'], function () {
        ...
        Route::get('pipeline', 'Settings@getPipeline')->name('setting.pipeline');
        ...
        Route::get('activity', 'Settings@getActivityType')->name('setting.activity');
        Route::get('activity/edit/{activity}', 'Settings@editActivityType')->name('setting.activity.edit');
        Route::post('activity/create', 'Settings@createActivityType')->name('setting.activity.create');
        Route::post('activity/update/{activity}', 'Settings@updateActivityType')->name('setting.activity.update');
        Route::delete('activity/delete/{activity}', 'Settings@destroyActivityType')->name('setting.activity.delete');

        Route::get('stage/{pipeline}', 'Settings@getStage')->name('setting.stage');
        ...
        Route::post('stage/update/{stage}', 'Settings@updateStage')->name('setting.deal.stage.update');
