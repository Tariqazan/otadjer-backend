...
<link rel="icon" sizes="512x512" href="{{ asset('public/img/icons/otadjer-512x512.png') }}">

<!-- Add to homescreen for Safari on iOS -->
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="#FFFFFF">
<meta name="apple-mobile-web-app-title" content="Otadjer">
<link rel="apple-touch-icon" href="{{ asset('public/img/icons/otadjer-512x512.png') }}">
...
<meta name="msapplication-TileImage" content="{{ asset('public/img/icons/otadjer-512x512.png') }}">
