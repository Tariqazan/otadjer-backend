...
return [
    ...
    'update'                => 'Оновити Otadjer до :version версія',
    'changelog'             => 'Історія змін',
    'check'                 => 'Позначити',
    'new_core'              => 'Оновлена версія Otadjer доступна.',
    'latest_core'           => 'Вітаємо! У вас є остання версія Otadjer. Майбутні оновлення безпеки буде застосовано автоматично.',
